package site.lifd.core.io;

import site.lifd.core.collection.CollUtil;
import com.lifd.core.io.file.*;
import site.lifd.core.io.file.FileWriter;
import site.lifd.core.io.resource.Resource;
import site.lifd.core.io.resource.ResourceUtil;
import site.lifd.core.io.unit.DataSizeUtil;
import site.lifd.core.lang.Assert;
import site.lifd.core.thread.ThreadUtil;
import com.lifd.core.util.*;
import site.lifd.core.io.file.*;
import site.lifd.core.util.*;
...
public class FileUtil extends PathUtil {
	...
	public static byte[] readBytes(File file) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file).readBytes();
	}
	...
	public static String readString(File file, Charset charset) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file, charset).readString();
	}
	...
	public static <T extends Collection<String>> T readLines(File file, String charset, T collection) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file, CharsetUtil.charset(charset)).readLines(collection);
	}
	...
	public static <T extends Collection<String>> T readLines(File file, Charset charset, T collection) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file, charset).readLines(collection);
	}
	...
	public static void readLines(File file, Charset charset, LineHandler lineHandler) throws IORuntimeException {
		site.lifd.core.io.file.FileReader.create(file, charset).readLines(lineHandler);
	}
	 ...
	 *
	 */
	public static <T> T loadUtf8(String path, site.lifd.core.io.file.FileReader.ReaderHandler<T> readerHandler) throws IORuntimeException {
	 ...
	 *
	 */
	public static <T> T load(String path, String charset, site.lifd.core.io.file.FileReader.ReaderHandler<T> readerHandler) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file(path), CharsetUtil.charset(charset)).read(readerHandler);
	}
	 ...
	 *
	 */
	public static <T> T load(String path, Charset charset, site.lifd.core.io.file.FileReader.ReaderHandler<T> readerHandler) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file(path), charset).read(readerHandler);
	}
	 ...
	 *
	 */
	public static <T> T loadUtf8(File file, site.lifd.core.io.file.FileReader.ReaderHandler<T> readerHandler) throws IORuntimeException {
	 ...
	 *
	 */
	public static <T> T load(File file, Charset charset, site.lifd.core.io.file.FileReader.ReaderHandler<T> readerHandler) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file, charset).read(readerHandler);
	}
	...
	public static BufferedWriter getWriter(File file, Charset charset, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, charset).getWriter(isAppend);
	}
	...
	public static File writeString(String content, File file, String charset) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).write(content);
	}
	...
	public static File writeString(String content, File file, Charset charset) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, charset).write(content);
	}
	...
	public static File appendString(String content, File file, String charset) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).append(content);
	}
	...
	public static File appendString(String content, File file, Charset charset) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, charset).append(content);
	}
	...
	public static <T> File writeLines(Collection<T> list, File file, String charset, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).writeLines(list, isAppend);
	}
	...
	public static <T> File writeLines(Collection<T> list, File file, Charset charset, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, charset).writeLines(list, isAppend);
	}
	...
	public static File writeUtf8Map(Map<?, ?> map, File file, String kvSeparator, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, CharsetUtil.CHARSET_UTF_8).writeMap(map, kvSeparator, isAppend);
	}
	...
	public static File writeMap(Map<?, ?> map, File file, Charset charset, String kvSeparator, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(file, charset).writeMap(map, kvSeparator, isAppend);
	}
	...
	public static File writeBytes(byte[] data, File dest, int off, int len, boolean isAppend) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(dest).write(data, off, len, isAppend);
	}
	...
	public static File writeFromStream(InputStream in, File dest, boolean isCloseIn) throws IORuntimeException {
		return site.lifd.core.io.file.FileWriter.create(dest).writeFromStream(in, isCloseIn);
	}
	...
	public static long writeToStream(File file, OutputStream out) throws IORuntimeException {
		return site.lifd.core.io.file.FileReader.create(file).writeToStream(out);
	}
