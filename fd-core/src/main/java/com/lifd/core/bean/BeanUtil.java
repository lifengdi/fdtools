package com.lifd.core.bean;

import com.lifd.core.bean.copier.BeanCopier;
import com.lifd.core.bean.copier.CopyOptions;
import com.lifd.core.bean.copier.ValueProvider;
import com.lifd.core.collection.CollUtil;
import com.lifd.core.collection.ListUtil;
import com.lifd.core.convert.Convert;
import com.lifd.core.lang.Dict;
import com.lifd.core.lang.Editor;
import com.lifd.core.map.CaseInsensitiveMap;
import com.lifd.core.map.MapUtil;
...
//		}
	 ...
	 * 如果isSimple为{@code true}，则只匹配类名而忽略包名，例如：com.lifd.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code false}，则匹配包括包名的全类名，例如：com.lifd.TestEntity匹配com.lifd.TestEntity
	 *
	 * @param bean          Bean
